	...
	<br />
		...
		<div id="content">
			<legend>Frequently Added Questions</legend>
				 ...
				 <h4>DO YOU SHIP?</h4>
					<p style="text-indent:60px;">Yes, we can.</p>
				<hr>
					<h4>DO YOU DELIVER?</h4>
						<p style="text-indent:60px;">No, We only offer Shipping.</p>
				<hr>
					<h3>WHEN WILL I GET MY ORDERS?</h3>
						<p style="text-indent:60px;">We will ship your product within 2-3 days.</p>
				<hr>
					<h3>HOW DO I PAY MY ORDERS?</h3>
					<p style="text-indent:60px;">You can pay amount by any online payment platform.</p>
